...
## What happens if you skip dfflibmap?
...
- Your final netlist will be incomplete / unmapped (not usable for P&R).
⚡ In short:
👉 dfflibmap = maps generic flip-flops → actual standard cell flip-flops (from .lib).
